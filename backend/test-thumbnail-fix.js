...
async function testThumbnailFix() {
  ...
  try {
    ...
    const response = await fetch(`https://facematrix.sonomainfotech.in/api/photos/${photoId}/thumbnail/public`);
    ...
    if (response.ok) {
      ...
      console.log(`\n🔗 Test URL: https://facematrix.sonomainfotech.in/client/access/JXPYWF5D`);
      console.log(`🖼️ Thumbnail URL: https://facematrix.sonomainfotech.in/api/photos/${photoId}/thumbnail/public`);
